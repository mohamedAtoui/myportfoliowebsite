...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Mohamed Atoui Portfolio",
    description:
      "Mohamed Atoui Portfolio is a portfolio template built with React, Typescript, Tailwind CSS, and Framer Motion. 100% open-source, and customizable.",
